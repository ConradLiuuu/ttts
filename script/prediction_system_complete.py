...
class Listener:
    def __init__(self):
        ...
        if sys.argv[1] == 'fixed':
            self.__classifier = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/classification_fixed')
            rospy.loginfo("loaded classification model")
            self.__pred_top5 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/prediction_top5')
            self.__pred_top6 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/prediction_top6')
            rospy.loginfo("loaded top prediction model")
            self.__pred_left5 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/prediction_left5')
            self.__pred_left6 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/prediction_left6')
            rospy.loginfo("loaded left prediction model")
            self.__pred_right5 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/prediction_right5')
            self.__pred_right6 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/prediction_right6')
            rospy.loginfo("loaded right prediction model")
            self.__pred_back5 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/prediction_back5')
            self.__pred_back6 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/fixed/prediction_back6')
            rospy.loginfo("loaded back prediction model")
            rospy.loginfo("Load fixed model")
        else:
            self.__classifier = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/classification_not_fixed')
            self.__pred_top5 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/prediction_not_fixed_top5')
            self.__pred_top6 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/prediction_not_fixed_top6')
            self.__pred_left5 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/prediction_not_fixed_left5')
            self.__pred_left6 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/prediction_not_fixed_left6')
            self.__pred_right5 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/prediction_not_fixed_right5')
            self.__pred_right6 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/prediction_not_fixed_right6')
            self.__pred_back5 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/prediction_not_fixed_back5')
            self.__pred_back6 = load_model('/home/lab606a/TableTennis_ws/src/ttts/models/not_fixed/prediction_not_fixed_back6')
...
if __name__ == '__main__':
    rospy.init_node('prediction_system_complete')
    plt.ion()
    rospy.loginfo("init node prediction_system_complete.py")
    Listener()
    rospy.spin()
